...
export default class Main extends Component {
    ...
    render() {
        let notes = this.state.emptyArr.map((val, key)=>{
            return <Note key={key} 
                         val={val}  keyval={key}
                         deleteFunction={()=>this.deleteLi(key)}/>
        });
        return (
            <View style={styles.container}>
                <View style={styles.header}>
                    ...
                    {/* <Text style={styles.headerText}><p>- TO DO APP -</p></Text> */}
                </View>
                ...
                <View style={styles.footer}>
                    <TextInput 
                        ...
                        onChangeText={(emptyText)=> this.setState({emptyText})}
